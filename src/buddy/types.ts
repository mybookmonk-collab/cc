...
// Customizable seed for companion bones — allows users to customize their companion
// while still keeping rarity deterministic and not easily cheatable
export type CompanionSeed = {
  // Optional custom seed to use instead of userId for rolling bones
  seed?: string
  // Overrides for specific bones properties (still validated against rarity)
  rarity?: Rarity
  species?: Species
  eye?: Eye
  hat?: Hat
...
// Additional companion customization that persists in config
export type StoredCompanionSeed = CompanionSeed
